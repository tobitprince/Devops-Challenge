...
```bash
git clone https://github.com/tobitprince/sports-alert-system.git
cd sports-alert-system
```
...
4. Name the topic (e.g., sport-alert-topic) and note the ARN.
...
### **Future Enhancements**
1. Add EPL score alerts for extended functionality.
